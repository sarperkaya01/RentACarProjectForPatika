...
@AttributeOverride(name = "id", column = @Column(name = "motor_id"))
public class Motorcycle extends BaseVehicle implements LandVehicle, FuelDriven {
    ...
    public MotorcycleMobility getMobilityType() { return mobilityType; }
    public void setMobilityType(MotorcycleMobility mobilityType) { this.mobilityType = mobilityType; }
}
